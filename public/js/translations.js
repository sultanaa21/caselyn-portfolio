...
const translations = {
    es: {
        ...
        'portfolio.melt.tagline': 'Landing premium para hamburguesería moderna.',
        'portfolio.juicy-brava.title': 'Juicy Brava',
        'portfolio.juicy-brava.category': 'Batidos & Smoothies',
        'portfolio.juicy-brava.tagline': 'Fruta fresca, sabor brutal, frente al mar.',
        ...
        'portfolio.fixnow.tagline': 'Landing optimizada para servicios a domicilio.',
        ...
        'portfolio.personajes-virtuales-ia.tagline': 'Escala tu producción de contenido digital sin límites.',
        ...
        'portfolio.frankburger.tagline': 'Las burgers que te harán volver.',
        ...
        'portfolio.azul-croissant.tagline': 'Croissants y café para tus mejores momentos.',
    ...
    ca: {
        ...
        'portfolio.melt.tagline': 'Landing premium per a hamburgueseria moderna.',
        'portfolio.juicy-brava.title': 'Juicy Brava',
        'portfolio.juicy-brava.category': 'Batuts & Smoothies',
        'portfolio.juicy-brava.tagline': 'Fruita fresca, sabor brutal, davant del mar.',
        'portfolio.juicy-brava.stack.0': 'Next.js',
        'portfolio.juicy-brava.stack.1': 'Framer Motion',
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Serveis Professionals',
        'portfolio.fixnow.tagline': 'Landing optimitzada per a serveis a domicili.',
        ...
        'portfolio.personajes-virtuales-ia.tagline': 'Escala la teva producció de contingut digital sense límits.',
        'portfolio.personajes-virtuales-ia.stack.0': 'Next.js',
        'portfolio.personajes-virtuales-ia.stack.1': 'Framer Motion',
        'portfolio.personajes-virtuales-ia.stack.2': 'Tailwind CSS',
        'portfolio.frankburger.title': 'FrankBurger',
        'portfolio.frankburger.category': 'Restauració',
        'portfolio.frankburger.tagline': 'Les burgers que et faran tornar.',
        'portfolio.frankburger.stack.0': 'Next.js',
        'portfolio.frankburger.stack.1': 'Tailwind CSS',
        'portfolio.azul-croissant.title': 'Azul Croissant',
        'portfolio.azul-croissant.category': 'Fleca & Cafè',
        'portfolio.azul-croissant.tagline': 'Croissants i cafè per als teus millors moments.',
        'portfolio.azul-croissant.stack.0': 'Next.js',
        'portfolio.azul-croissant.stack.1': 'Tailwind CSS',
    ...
    en: {
        ...
        'portfolio.melt.tagline': 'Premium landing page for a modern burger joint.',
        'portfolio.juicy-brava.title': 'Juicy Brava',
        'portfolio.juicy-brava.category': 'Smoothies & Drinks',
        'portfolio.juicy-brava.tagline': 'Fresh fruit, brutal flavor, by the sea.',
        'portfolio.juicy-brava.stack.0': 'Next.js',
        'portfolio.juicy-brava.stack.1': 'Framer Motion',
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Professional Services',
        'portfolio.fixnow.tagline': 'Optimized landing page for home services.',
        ...
        'portfolio.personajes-virtuales-ia.tagline': 'Scale your digital content production without limits.',
        'portfolio.personajes-virtuales-ia.stack.0': 'Next.js',
        'portfolio.personajes-virtuales-ia.stack.1': 'Framer Motion',
        'portfolio.personajes-virtuales-ia.stack.2': 'Tailwind CSS',
        'portfolio.frankburger.title': 'FrankBurger',
        'portfolio.frankburger.category': 'Restaurants',
        'portfolio.frankburger.tagline': 'The burgers that will keep you coming back.',
        'portfolio.frankburger.stack.0': 'Next.js',
        'portfolio.frankburger.stack.1': 'Tailwind CSS',
        'portfolio.azul-croissant.title': 'Azul Croissant',
        'portfolio.azul-croissant.category': 'Bakery & Coffee',
        'portfolio.azul-croissant.tagline': 'Croissants and coffee for your best moments.',
        'portfolio.azul-croissant.stack.0': 'Next.js',
        'portfolio.azul-croissant.stack.1': 'Tailwind CSS',
    ...
    fr: {
        ...
        // Social Proof
        'social.title': 'Nous créons pour les entreprises qui veulent se démarquer',
        'social.stat1.number': '100%',
        'social.stat1.label': 'Mobile d\'abord',
        'social.stat2.number': 'Rapide',
        'social.stat2.label': 'Chargement instantané',
        'social.stat3.number': '24h',
        'social.stat3.label': 'Temps de réponse',

        // Services
        'services.title': 'Conception Web Professionnelle pour Restaurants et Commerces',
        'services.description': 'Trois services conçus pour développer votre activité en ligne',
        'services.card1.title': 'Conception Web',
        'services.card1.description': 'Votre entreprise en ligne, prête à vendre. Des designs professionnels qui inspirent confiance et facilitent le contact avec vos clients.',
        'services.card2.title': 'Développement Web',
        'services.card2.description': 'Rapide, professionnel et facile à mettre à jour. Votre site fonctionnera parfaitement sur tous les appareils et sera facile à trouver sur Google.',
        'services.card3.title': 'Stratégie Digitale',
        'services.card3.description': 'Nous vous aidons à atteindre plus de clients. De Google Maps aux réseaux sociaux, nous veillons à ce que votre entreprise soit visible là où vos clients vous cherchent.',

        // Portfolio
        'portfolio.title': 'Des sites web qui fonctionnent pour de vraies entreprises',
        'portfolio.description': 'Chaque site est conçu pour convertir les visiteurs en clients',
        ...
        'portfolio.melt.tagline': 'Landing page premium pour un restaurant de burgers moderne.',
        'portfolio.juicy-brava.title': 'Juicy Brava',
        'portfolio.juicy-brava.category': 'Smoothies & Boissons',
        'portfolio.juicy-brava.tagline': 'Fruits frais, saveur brutale, face à la mer.',
        'portfolio.juicy-brava.stack.0': 'Next.js',
        'portfolio.juicy-brava.stack.1': 'Framer Motion',
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Services professionnels',
        'portfolio.fixnow.tagline': 'Landing page optimisée pour les services à domicile.',
        ...
        'portfolio.personajes-virtuales-ia.tagline': 'Augmentez votre production de contenu digital sans limites.',
        'portfolio.personajes-virtuales-ia.stack.0': 'Next.js',
        'portfolio.personajes-virtuales-ia.stack.1': 'Framer Motion',
        'portfolio.personajes-virtuales-ia.stack.2': 'Tailwind CSS',
        'portfolio.frankburger.title': 'FrankBurger',
        'portfolio.frankburger.category': 'Restauration',
        'portfolio.frankburger.tagline': 'Les burgers qui vous feront revenir.',
        'portfolio.frankburger.stack.0': 'Next.js',
        'portfolio.frankburger.stack.1': 'Tailwind CSS',
        'portfolio.azul-croissant.title': 'Azul Croissant',
        'portfolio.azul-croissant.category': 'Boulangerie & Café',
        'portfolio.azul-croissant.tagline': 'Croissants et café pour vos meilleurs moments.',
        'portfolio.azul-croissant.stack.0': 'Next.js',
        'portfolio.azul-croissant.stack.1': 'Tailwind CSS',

        // Process
        'process.title': 'Comment nous créons votre site web',
        'process.description': 'Un processus simple et transparent, sans surprises',
        'process.step1.title': 'Consultation initiale',
        'process.step1.description': 'Nous discutons de votre activité, vos objectifs et ce que vous devez communiquer. Sans engagement, sans pression.',
        'process.step2.title': 'Design personnalisé',
        'process.step2.description': 'Nous créons un design unique pour votre marque. Nous vous montrons l\'apparence de votre site avant de commencer à coder.',
        'process.step3.title': 'Développement et ajustements',
        'process.step3.description': 'Nous construisons votre site avec les meilleures technologies. Nous révisons chaque détail ensemble jusqu\'à ce qu\'il soit parfait.',
        'process.step4.title': 'Lancement',
        'process.step4.description': 'Votre site est en ligne. Nous vous apprenons à l\'utiliser et restons disponibles pour toute question ou modification.',

        // FAQ
        'faq.title': 'Questions sur la conception web pour les entreprises locales',
        'faq.description': 'Des réponses claires aux questions les plus courantes',
        'faq.q1': 'Combien coûte un site web pour mon restaurant ou mon entreprise ?',
        'faq.a1': 'Le prix dépend de vos besoins : des sites simples pour présenter votre menu ou vos services, jusqu\'aux systèmes de réservation en ligne. Nous vous donnons un devis clair dès le premier jour, sans surprises. La plupart des projets sont prêts en 2 à 4 semaines.',
        'faq.q2': 'Ai-je besoin d\'un site web si mon entreprise est locale ?',
        'faq.a2': 'Oui. Aujourd\'hui, la plupart des clients cherchent sur Google ou les réseaux sociaux avant de prendre une décision. Un site professionnel vous donne de la crédibilité, vous rend visible et facilite le contact. C\'est votre meilleur vendeur, disponible 24h/24.',
        'faq.q3': 'Le site fonctionne-t-il bien sur mobile ?',
        'faq.a3': 'Oui, toujours. Nous concevons d\'abord pour le mobile, car c\'est là que la plupart de vos clients verront votre site. Il sera parfait sur tous les appareils.',
        'faq.q4': 'Que comprend la conception web professionnelle ?',
        'faq.a4': 'Elle comprend un design sur mesure, un développement responsive (parfait sur mobile), l\'optimisation de la vitesse, le SEO de base pour Google, un formulaire de contact et une configuration complète. Nous le livrons prêt à recevoir des clients.',
        'faq.q5': 'Aidez-vous avec le domaine et l\'hébergement ?',
        'faq.a5': 'Oui, nous nous occupons de tout. Nous vous aidons à choisir le meilleur domaine et gérons tous les aspects techniques pour que vous n\'ayez à vous soucier de rien.',
        'faq.q6': 'Offrez-vous une garantie ?',
        'faq.a6': 'Votre site fonctionnera correctement dès le premier jour. En cas de problème technique dans les 30 premiers jours, nous le corrigeons sans frais supplémentaires.',
        ...
        'contact.form.message.placeholder': 'Quel type d\'entreprise avez-vous et de quoi avez-vous besoin',
        'contact.form.submit': 'Envoyer le message',

        // Footer
        'footer.copyright': '© 2026 Caselyn. Conception web professionnelle pour les entreprises locales.',
