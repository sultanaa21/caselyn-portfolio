...
const translations = {
    es: {
        ...
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Servicios Profesionales',
        'portfolio.fixnow.tagline': 'Landing para servicios profesionales a domicilio.',
        'portfolio.fixnow.stack.1': 'Formulario',
        'portfolio.fixnow.stack.2': 'SEO optimizado',
    ...
    ca: {
        ...
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Serveis Professionals',
        'portfolio.fixnow.tagline': 'Landing per a serveis professionals a domicili.',
        'portfolio.fixnow.stack.1': 'Formulari',
        'portfolio.fixnow.stack.2': 'SEO optimitzat',
    ...
    en: {
        ...
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Professional Services',
        'portfolio.fixnow.tagline': 'Landing for professional home services.',
        'portfolio.fixnow.stack.1': 'Contact form',
        'portfolio.fixnow.stack.2': 'SEO optimized',
    ...
    fr: {
        ...
        'portfolio.juicy-brava.stack.2': 'Tailwind CSS',
        'portfolio.fixnow.title': 'FixNow',
        'portfolio.fixnow.category': 'Services professionnels',
        'portfolio.fixnow.tagline': 'Landing pour des services professionnels à domicile.',
        'portfolio.fixnow.stack.1': 'Formulaire',
        'portfolio.fixnow.stack.2': 'SEO optimisé',
