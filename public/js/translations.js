...
const translations = {
    es: {
        ...
        'cookies.updated': '<strong>Última actualización:</strong> 13 de junio de 2026',
        'cookies.intro': 'En esta Política de Cookies te explicamos qué tecnologías de almacenamiento utiliza esta web y para qué sirven.',
        'cookies.s1.title': '1. Qué son las cookies y tecnologías similares',
        'cookies.s1.p1': 'Las cookies son pequeños archivos que una página web puede guardar en tu navegador para recordar información sobre tu visita o permitir determinadas funciones.',
        'cookies.s1.p2': 'Además de las cookies, existen tecnologías similares, como el almacenamiento local del navegador (localStorage), que también pueden guardar información en tu dispositivo.',
        'cookies.s2.title': '2. Qué usamos en esta web',
        'cookies.s2.p1': 'Actualmente, la web de Caselyn no utiliza cookies de análisis, seguimiento, publicidad personalizada ni redes sociales.',
        'cookies.s2.p2': 'No utilizamos herramientas como Google Analytics, Meta Pixel, TikTok Pixel, Hotjar, Microsoft Clarity u otras tecnologías similares de medición o rastreo.',
        'cookies.s2.p3': 'La web puede utilizar almacenamiento local del navegador para recordar preferencias técnicas elegidas por el usuario, como el idioma seleccionado.',
        'cookies.s2.p4': 'Esta información se utiliza únicamente para mejorar la experiencia de navegación y recordar la preferencia indicada. No se usa para crear perfiles, analizar tu comportamiento, mostrar publicidad personalizada ni compartir datos con terceros para marketing.',
        'cookies.s3.title': '3. Tabla de tecnologías utilizadas',
        'cookies.s3.col1': 'Tecnología',
        'cookies.s3.col2': 'Tipo',
        'cookies.s3.col3': 'Finalidad',
        'cookies.s3.col4': 'Duración',
        'cookies.s3.col5': 'Responsable',
        'cookies.s3.row1.tech': 'Almacenamiento local del navegador',
        'cookies.s3.row1.type': 'Preferencia técnica',
        'cookies.s3.row1.purpose': 'Recordar el idioma seleccionado por el usuario',
        'cookies.s3.row1.duration': 'Hasta que el usuario cambie o borre la preferencia desde su navegador',
        'cookies.s3.note': 'Si en el futuro se incorporan otras cookies o tecnologías similares, esta tabla se actualizará para indicar su nombre, finalidad, duración y responsable.',
        'cookies.s4.title': '4. Lo que no hacemos',
        'cookies.s4.p1': 'En esta web:',
        'cookies.s4.li1': 'No usamos Google Analytics ni herramientas de analítica web.',
        'cookies.s4.li2': 'No usamos píxeles publicitarios.',
        'cookies.s4.li3': 'No rastreamos tu comportamiento con fines comerciales.',
        'cookies.s4.li4': 'No mostramos publicidad personalizada.',
        'cookies.s4.li5': 'No instalamos cookies de redes sociales.',
        'cookies.s4.li6': 'No compartimos datos de navegación con terceros para marketing.',
        'cookies.s5.title': '5. ¿Necesitas aceptar cookies?',
        'cookies.s5.p1': 'No. Actualmente esta web solo utiliza tecnologías técnicas o de preferencia necesarias para recordar opciones elegidas por el usuario, como el idioma.',
        'cookies.s5.p2': 'Por ese motivo, no mostramos un banner de consentimiento de cookies.',
        'cookies.s5.p3': 'Si en el futuro incorporamos cookies de análisis, publicidad, medición, remarketing o cualquier otra tecnología que requiera consentimiento, actualizaremos esta política y mostraremos el sistema de consentimiento correspondiente.',
        'cookies.s6.title': '6. Cómo puedes gestionar o eliminar estas tecnologías',
        'cookies.s6.p1': 'Puedes eliminar o bloquear cookies y datos almacenados desde la configuración de tu navegador.',
        'cookies.s6.p2': 'También puedes borrar el almacenamiento local asociado a esta web desde las herramientas de privacidad o configuración del navegador.',
        'cookies.s6.p3': 'Ten en cuenta que, si eliminas estos datos, es posible que la web no recuerde algunas preferencias, como el idioma seleccionado.',
        'cookies.s6.p4': 'Puedes consultar las opciones de gestión en los principales navegadores:',
        'cookies.s6.li1': 'Chrome: Configuración → Privacidad y seguridad → Cookies y otros datos de sitios.',
        'cookies.s6.li2': 'Firefox: Ajustes → Privacidad y seguridad → Cookies y datos del sitio.',
        'cookies.s6.li3': 'Safari: Ajustes o Preferencias → Privacidad → Gestionar datos de sitios web.',
        'cookies.s6.li4': 'Edge: Configuración → Cookies y permisos del sitio → Administrar y eliminar cookies y datos del sitio.',
        'cookies.s7.title': '7. Enlaces a terceros',
        'cookies.s7.p1': 'La web puede incluir enlaces a plataformas externas como Instagram, TikTok o YouTube.',
        'cookies.s7.p2': 'Estos enlaces no instalan cookies por sí mismos desde la web de Caselyn. Sin embargo, si accedes a esas plataformas, quedarás sujeto a sus propias políticas de cookies y privacidad.',
        'cookies.s8.title': '8. Cambios en esta Política de Cookies',
        'cookies.s8.p1': 'Podemos actualizar esta Política de Cookies si incorporamos nuevas funcionalidades, herramientas de análisis, servicios externos, píxeles publicitarios o cualquier otra tecnología que afecte al almacenamiento de información en tu navegador.',
        'cookies.s8.p2': 'Cuando hagamos cambios relevantes, actualizaremos la fecha indicada al inicio de esta página.',
        'cookies.s9.title': '9. Contacto',
        'cookies.s9.p1': 'Si tienes dudas sobre esta Política de Cookies, puedes escribirnos a: <a href="mailto:caselyncontact@gmail.com" class="legal-link">caselyncontact@gmail.com</a>',
    },
    ...
    ca: {
        ...
        // Cookie Policy
        'cookies.title': 'Política de Cookies',
        'cookies.updated': '<strong>Última actualització:</strong> 13 de juny de 2026',
        'cookies.intro': 'En aquesta Política de Cookies t\'expliquem quines tecnologies d\'emmagatzematge fa servir aquesta web i per a què serveixen.',
        'cookies.s1.title': '1. Què són les cookies i tecnologies similars',
        'cookies.s1.p1': 'Les cookies són petits arxius que una pàgina web pot guardar al teu navegador per recordar informació sobre la teva visita o permetre determinades funcions.',
        'cookies.s1.p2': 'A més de les cookies, hi ha tecnologies similars, com l\'emmagatzematge local del navegador (localStorage), que també poden guardar informació al teu dispositiu.',
        'cookies.s2.title': '2. Què fem servir en aquesta web',
        'cookies.s2.p1': 'Actualment, la web de Caselyn no fa servir cookies d\'anàlisi, seguiment, publicitat personalitzada ni xarxes socials.',
        'cookies.s2.p2': 'No fem servir eines com Google Analytics, Meta Pixel, TikTok Pixel, Hotjar, Microsoft Clarity ni altres tecnologies similars de mesura o rastreig.',
        'cookies.s2.p3': 'La web pot fer servir emmagatzematge local del navegador per recordar preferències tècniques triades per l\'usuari, com l\'idioma seleccionat.',
        'cookies.s2.p4': 'Aquesta informació s\'utilitza únicament per millorar l\'experiència de navegació i recordar la preferència indicada. No es fa servir per crear perfils, analitzar el teu comportament, mostrar publicitat personalitzada ni compartir dades amb tercers per a màrqueting.',
        'cookies.s3.title': '3. Taula de tecnologies utilitzades',
        'cookies.s3.col1': 'Tecnologia',
        'cookies.s3.col2': 'Tipus',
        'cookies.s3.col3': 'Finalitat',
        'cookies.s3.col4': 'Durada',
        'cookies.s3.col5': 'Responsable',
        'cookies.s3.row1.tech': 'Emmagatzematge local del navegador',
        'cookies.s3.row1.type': 'Preferència tècnica',
        'cookies.s3.row1.purpose': 'Recordar l\'idioma seleccionat per l\'usuari',
        'cookies.s3.row1.duration': 'Fins que l\'usuari canviï o esborri la preferència des del seu navegador',
        'cookies.s3.note': 'Si en el futur s\'incorporen altres cookies o tecnologies similars, aquesta taula s\'actualitzarà per indicar el seu nom, finalitat, durada i responsable.',
        'cookies.s4.title': '4. El que no fem',
        'cookies.s4.p1': 'En aquesta web:',
        'cookies.s4.li1': 'No fem servir Google Analytics ni eines d\'analítica web.',
        'cookies.s4.li2': 'No fem servir píxels publicitaris.',
        'cookies.s4.li3': 'No rastregem el teu comportament amb fins comercials.',
        'cookies.s4.li4': 'No mostrem publicitat personalitzada.',
        'cookies.s4.li5': 'No instal·lem cookies de xarxes socials.',
        'cookies.s4.li6': 'No compartim dades de navegació amb tercers per a màrqueting.',
        'cookies.s5.title': '5. Necessites acceptar cookies?',
        'cookies.s5.p1': 'No. Actualment aquesta web només fa servir tecnologies tècniques o de preferència necessàries per recordar opcions triades per l\'usuari, com l\'idioma.',
        'cookies.s5.p2': 'Per aquest motiu, no mostrem un bàner de consentiment de cookies.',
        'cookies.s5.p3': 'Si en el futur incorporem cookies d\'anàlisi, publicitat, mesura, remarketing o qualsevol altra tecnologia que requereixi consentiment, actualitzarem aquesta política i mostrarem el sistema de consentiment corresponent.',
        'cookies.s6.title': '6. Com pots gestionar o eliminar aquestes tecnologies',
        'cookies.s6.p1': 'Pots eliminar o bloquejar cookies i dades emmagatzemades des de la configuració del teu navegador.',
        'cookies.s6.p2': 'També pots esborrar l\'emmagatzematge local associat a aquesta web des de les eines de privacitat o configuració del navegador.',
        'cookies.s6.p3': 'Tingues en compte que, si elimines aquestes dades, és possible que la web no recordi algunes preferències, com l\'idioma seleccionat.',
        'cookies.s6.p4': 'Pots consultar les opcions de gestió als principals navegadors:',
        'cookies.s6.li1': 'Chrome: Configuració → Privacitat i seguretat → Cookies i altres dades de llocs.',
        'cookies.s6.li2': 'Firefox: Ajustos → Privacitat i seguretat → Cookies i dades del lloc.',
        'cookies.s6.li3': 'Safari: Ajustos o Preferències → Privacitat → Gestionar dades de llocs web.',
        'cookies.s6.li4': 'Edge: Configuració → Cookies i permisos del lloc → Administrar i eliminar cookies i dades del lloc.',
        'cookies.s7.title': '7. Enllaços a tercers',
        'cookies.s7.p1': 'La web pot incloure enllaços a plataformes externes com Instagram, TikTok o YouTube.',
        'cookies.s7.p2': 'Aquests enllaços no instal·len cookies per ells mateixos des de la web de Caselyn. No obstant això, si accedeixes a aquestes plataformes, quedaràs subjecte a les seves pròpies polítiques de cookies i privacitat.',
        'cookies.s8.title': '8. Canvis en aquesta Política de Cookies',
        'cookies.s8.p1': 'Podem actualitzar aquesta Política de Cookies si incorporem noves funcionalitats, eines d\'anàlisi, serveis externs, píxels publicitaris o qualsevol altra tecnologia que afecti l\'emmagatzematge d\'informació al teu navegador.',
        'cookies.s8.p2': 'Quan fem canvis rellevants, actualitzarem la data indicada a l\'inici d\'aquesta pàgina.',
        'cookies.s9.title': '9. Contacte',
        'cookies.s9.p1': 'Si tens dubtes sobre aquesta Política de Cookies, pots escriure\'ns a: <a href="mailto:caselyncontact@gmail.com" class="legal-link">caselyncontact@gmail.com</a>',
    },
    ...
    en: {
        ...
        'cookies.updated': '<strong>Last updated:</strong> June 13, 2026',
        'cookies.intro': 'In this Cookie Policy we explain what storage technologies this website uses and what they are for.',
        'cookies.s1.title': '1. What are cookies and similar technologies',
        'cookies.s1.p1': 'Cookies are small files that a website can save in your browser to remember information about your visit or enable certain functions.',
        'cookies.s1.p2': 'In addition to cookies, there are similar technologies, such as browser local storage (localStorage), which can also store information on your device.',
        'cookies.s2.title': '2. What we use on this website',
        'cookies.s2.p1': 'Currently, the Caselyn website does not use analytics, tracking, personalised advertising or social media cookies.',
        'cookies.s2.p2': 'We do not use tools such as Google Analytics, Meta Pixel, TikTok Pixel, Hotjar, Microsoft Clarity or other similar measurement or tracking technologies.',
        'cookies.s2.p3': 'The website may use browser local storage to remember technical preferences chosen by the user, such as the selected language.',
        'cookies.s2.p4': 'This information is used solely to improve the browsing experience and remember the indicated preference. It is not used to create profiles, analyse your behaviour, show personalised advertising or share data with third parties for marketing.',
        'cookies.s3.title': '3. Table of technologies used',
        'cookies.s3.col1': 'Technology',
        'cookies.s3.col2': 'Type',
        'cookies.s3.col3': 'Purpose',
        'cookies.s3.col4': 'Duration',
        'cookies.s3.col5': 'Controller',
        'cookies.s3.row1.tech': 'Browser local storage',
        'cookies.s3.row1.type': 'Technical preference',
        'cookies.s3.row1.purpose': 'Remember the language selected by the user',
        'cookies.s3.row1.duration': 'Until the user changes or clears the preference from their browser',
        'cookies.s3.note': 'If other cookies or similar technologies are incorporated in the future, this table will be updated to indicate their name, purpose, duration and controller.',
        'cookies.s4.title': '4. What we do not do',
        'cookies.s4.p1': 'On this website:',
        'cookies.s4.li1': 'We do not use Google Analytics or web analytics tools.',
        'cookies.s4.li2': 'We do not use advertising pixels.',
        'cookies.s4.li3': 'We do not track your behaviour for commercial purposes.',
        'cookies.s4.li4': 'We do not show personalised advertising.',
        'cookies.s4.li5': 'We do not install social media cookies.',
        'cookies.s4.li6': 'We do not share browsing data with third parties for marketing.',
        'cookies.s5.title': '5. Do you need to accept cookies?',
        'cookies.s5.p1': 'No. This website currently only uses technical or preference technologies necessary to remember options chosen by the user, such as language.',
        'cookies.s5.p2': 'For this reason, we do not show a cookie consent banner.',
        'cookies.s5.p3': 'If we incorporate analytics cookies, advertising, measurement, remarketing or any other technology requiring consent in the future, we will update this policy and display the corresponding consent system.',
        'cookies.s6.title': '6. How you can manage or delete these technologies',
        'cookies.s6.p1': 'You can delete or block cookies and stored data from your browser settings.',
        'cookies.s6.p2': 'You can also clear the local storage associated with this website from the privacy tools or settings in your browser.',
        'cookies.s6.p3': 'Please note that if you delete this data, the website may not remember some preferences, such as the selected language.',
        'cookies.s6.p4': 'You can find management options in the main browsers:',
        'cookies.s6.li1': 'Chrome: Settings → Privacy and security → Cookies and other site data.',
        'cookies.s6.li2': 'Firefox: Settings → Privacy and Security → Cookies and Site Data.',
        'cookies.s6.li3': 'Safari: Settings or Preferences → Privacy → Manage Website Data.',
        'cookies.s6.li4': 'Edge: Settings → Cookies and site permissions → Manage and delete cookies and site data.',
        'cookies.s7.title': '7. Third-party links',
        'cookies.s7.p1': 'The website may include links to external platforms such as Instagram, TikTok or YouTube.',
        'cookies.s7.p2': 'These links do not install cookies themselves from the Caselyn website. However, if you access those platforms, you will be subject to their own cookie and privacy policies.',
        'cookies.s8.title': '8. Changes to this Cookie Policy',
        'cookies.s8.p1': 'We may update this Cookie Policy if we incorporate new features, analytics tools, external services, advertising pixels or any other technology that affects the storage of information in your browser.',
        'cookies.s8.p2': 'When we make significant changes, we will update the date shown at the top of this page.',
        'cookies.s9.title': '9. Contact',
        'cookies.s9.p1': 'If you have questions about this Cookie Policy, you can write to us at: <a href="mailto:caselyncontact@gmail.com" class="legal-link">caselyncontact@gmail.com</a>',
    },
    ...
    fr: {
        ...
        'cookies.updated': '<strong>Dernière mise à jour :</strong> 13 juin 2026',
        'cookies.intro': 'Dans cette Politique de Cookies, nous vous expliquons quelles technologies de stockage ce site web utilise et à quoi elles servent.',
        'cookies.s1.title': '1. Que sont les cookies et les technologies similaires',
        'cookies.s1.p1': 'Les cookies sont de petits fichiers qu\'un site web peut enregistrer dans votre navigateur pour mémoriser des informations sur votre visite ou permettre certaines fonctions.',
        'cookies.s1.p2': 'En plus des cookies, il existe des technologies similaires, comme le stockage local du navigateur (localStorage), qui peuvent également stocker des informations sur votre appareil.',
        'cookies.s2.title': '2. Ce que nous utilisons sur ce site',
        'cookies.s2.p1': 'Actuellement, le site de Caselyn n\'utilise pas de cookies d\'analyse, de suivi, de publicité personnalisée ni de réseaux sociaux.',
        'cookies.s2.p2': 'Nous n\'utilisons pas d\'outils tels que Google Analytics, Meta Pixel, TikTok Pixel, Hotjar, Microsoft Clarity ou d\'autres technologies similaires de mesure ou de suivi.',
        'cookies.s2.p3': 'Le site peut utiliser le stockage local du navigateur pour mémoriser les préférences techniques choisies par l\'utilisateur, comme la langue sélectionnée.',
        'cookies.s2.p4': 'Ces informations sont utilisées uniquement pour améliorer l\'expérience de navigation et mémoriser la préférence indiquée. Elles ne sont pas utilisées pour créer des profils, analyser votre comportement, afficher de la publicité personnalisée ni partager des données avec des tiers à des fins marketing.',
        'cookies.s3.title': '3. Tableau des technologies utilisées',
        'cookies.s3.col1': 'Technologie',
        'cookies.s3.col2': 'Type',
        'cookies.s3.col3': 'Finalité',
        'cookies.s3.col4': 'Durée',
        'cookies.s3.col5': 'Responsable',
        'cookies.s3.row1.tech': 'Stockage local du navigateur',
        'cookies.s3.row1.type': 'Préférence technique',
        'cookies.s3.row1.purpose': 'Mémoriser la langue sélectionnée par l\'utilisateur',
        'cookies.s3.row1.duration': 'Jusqu\'à ce que l\'utilisateur modifie ou supprime la préférence depuis son navigateur',
        'cookies.s3.note': 'Si d\'autres cookies ou technologies similaires sont incorporés à l\'avenir, ce tableau sera mis à jour pour indiquer leur nom, leur finalité, leur durée et leur responsable.',
        'cookies.s4.title': '4. Ce que nous ne faisons pas',
        'cookies.s4.p1': 'Sur ce site :',
        'cookies.s4.li1': 'Nous n\'utilisons pas Google Analytics ni d\'outils d\'analyse web.',
        'cookies.s4.li2': 'Nous n\'utilisons pas de pixels publicitaires.',
        'cookies.s4.li3': 'Nous ne suivons pas votre comportement à des fins commerciales.',
        'cookies.s4.li4': 'Nous n\'affichons pas de publicité personnalisée.',
        'cookies.s4.li5': 'Nous n\'installons pas de cookies de réseaux sociaux.',
        'cookies.s4.li6': 'Nous ne partageons pas de données de navigation avec des tiers à des fins marketing.',
        'cookies.s5.title': '5. Devez-vous accepter les cookies ?',
        'cookies.s5.p1': 'Non. Ce site n\'utilise actuellement que des technologies techniques ou de préférence nécessaires pour mémoriser les options choisies par l\'utilisateur, comme la langue.',
        'cookies.s5.p2': 'Pour cette raison, nous n\'affichons pas de bannière de consentement aux cookies.',
        'cookies.s5.p3': 'Si nous incorporons à l\'avenir des cookies d\'analyse, de publicité, de mesure, de remarketing ou toute autre technologie nécessitant un consentement, nous mettrons à jour cette politique et afficherons le système de consentement correspondant.',
        'cookies.s6.title': '6. Comment gérer ou supprimer ces technologies',
        'cookies.s6.p1': 'Vous pouvez supprimer ou bloquer les cookies et les données stockées depuis les paramètres de votre navigateur.',
        'cookies.s6.p2': 'Vous pouvez également effacer le stockage local associé à ce site depuis les outils de confidentialité ou les paramètres de votre navigateur.',
        'cookies.s6.p3': 'Veuillez noter que si vous supprimez ces données, il est possible que le site ne mémorise plus certaines préférences, comme la langue sélectionnée.',
        'cookies.s6.p4': 'Vous pouvez consulter les options de gestion dans les principaux navigateurs :',
        'cookies.s6.li1': 'Chrome : Paramètres → Confidentialité et sécurité → Cookies et autres données des sites.',
        'cookies.s6.li2': 'Firefox : Paramètres → Vie privée et sécurité → Cookies et données du site.',
        'cookies.s6.li3': 'Safari : Réglages ou Préférences → Confidentialité → Gérer les données des sites web.',
        'cookies.s6.li4': 'Edge : Paramètres → Cookies et autorisations des sites → Gérer et supprimer les cookies et données des sites.',
        'cookies.s7.title': '7. Liens vers des tiers',
        'cookies.s7.p1': 'Le site peut inclure des liens vers des plateformes externes telles qu\'Instagram, TikTok ou YouTube.',
        'cookies.s7.p2': 'Ces liens n\'installent pas eux-mêmes des cookies depuis le site de Caselyn. Cependant, si vous accédez à ces plateformes, vous serez soumis à leurs propres politiques de cookies et de confidentialité.',
        'cookies.s8.title': '8. Modifications de cette Politique de Cookies',
        'cookies.s8.p1': 'Nous pouvons mettre à jour cette Politique de Cookies si nous incorporons de nouvelles fonctionnalités, des outils d\'analyse, des services externes, des pixels publicitaires ou toute autre technologie affectant le stockage d\'informations dans votre navigateur.',
        'cookies.s8.p2': 'Lorsque nous apportons des modifications importantes, nous mettrons à jour la date indiquée au début de cette page.',
        'cookies.s9.title': '9. Contact',
        'cookies.s9.p1': 'Si vous avez des questions sur cette Politique de Cookies, vous pouvez nous écrire à : <a href="mailto:caselyncontact@gmail.com" class="legal-link">caselyncontact@gmail.com</a>',
    },
};
