...
const translations = {
    ...
    fr: {
        ...
        'portfolio.card1.tag': 'Restaurant',
        'portfolio.card1.title': 'Casa Luna',
        'portfolio.card1.description': 'Site professionnel avec menu digital et réservations WhatsApp. Augmentation de 40% des demandes clients.',
        'portfolio.card1.result.label': 'Résultat :',
        'portfolio.card1.result.value': '+40% nouvelles demandes',
        'portfolio.card1.badge1': 'Menu digital',
        'portfolio.card1.badge2': 'WhatsApp',
        'portfolio.card1.badge3': 'SEO local',
        'portfolio.card2.tag': 'Salon de Beauté',
        'portfolio.card2.title': 'Studio Belle',
        'portfolio.card2.description': 'Site élégant avec galerie de services et rendez-vous en ligne. Acquisition de nouveaux clients chaque semaine.',
        'portfolio.card2.result.label': 'Résultat :',
        'portfolio.card2.result.value': '8-12 rendez-vous / semaine',
        'portfolio.card2.badge1': 'Galerie',
        'portfolio.card2.badge2': 'Réservation en ligne',
        'portfolio.card2.badge3': 'Mobile-first',
        'portfolio.card3.tag': 'Services Professionnels',
        'portfolio.card3.title': 'FixNow',
        'portfolio.card3.description': 'Landing page optimisée avec formulaire de contact direct. Meilleure perception de professionnalisme par les clients.',
        'portfolio.card3.result.label': 'Résultat :',
        'portfolio.card3.result.value': '3x plus de demandes',
        'portfolio.card3.badge1': 'Landing page',
        'portfolio.card3.badge2': 'Formulaire de contact',
        'portfolio.card3.badge3': 'SEO optimisé',
        ...
        'contact.form.email': 'Email ou Téléphone',
        'contact.form.email.placeholder': 'Pour pouvoir vous contacter',
