...
(async () => {
  ...
  await page.goto('https://sa-gavina-mar.vercel.app/', { waitUntil: 'networkidle', timeout: 30000 });

  // Desktop screenshot: 1600x1000 (16:10)
  await page.setViewportSize({ width: 1600, height: 1000 });
  await page.screenshot({
    path: 'public/images/portfolio/sa-gavina-mar-desktop.png',
  ...
  await page.screenshot({
    path: 'public/images/portfolio/sa-gavina-mar-mobile.png',
  ...
  const files = [
    'public/images/portfolio/sa-gavina-mar-desktop.png',
    'public/images/portfolio/sa-gavina-mar-mobile.png'
  ];
